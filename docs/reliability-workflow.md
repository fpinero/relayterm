...
These findings and their automated native evidence apply to candidate `d6efd7f`. The manual matrix and final technical reconciliation are complete, as recorded in the [M11 final technical review](m11-final-review.md). M11 remains incomplete until independent PR review, merge, main synchronization, post-merge CI, and handoff pass.
