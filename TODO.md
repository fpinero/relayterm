...
- M12.CORRECTION-PLATFORMS: On candidate 691a8fb, complete macOS disconnected indicators, disconnected release-chord navigation, bounded diagnostics and native exit; complete Windows correction and informational form-feedback observations. Reconcile acceptance of the demonstrated SSH transport-loss recovery and fixed-grid history limits recorded in docs/m12-linux-final-report.md; preserve the original failed observations.
